...
async def start(message: Message):
    await message.answer(
        "Привет, я бот. Я умею: \nПоказывать погоду в вашем городе, \nПереводить текст в аудио(с переводом с английского на русский), \nПрисылать фото, \nПереводить текст с русского на английский. \nДля получения дополнительной информации введите команду /help")
